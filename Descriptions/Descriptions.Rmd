...
#ure_RNA - total number of genes in each cell
...
VlnPlot(pbmc, features = c("ure_RNA", "nCount_RNA", "percent.mt"), ncol = 3)
...
plot2 <- FeatureScatter(pbmc, feature1 = "nCount_RNA", feature2 = "ure_RNA")
plot1 + plot2
```
...
pbmc <- subset(pbmc, subset = ure_RNA > 200 & ure_RNA < 2500 & percent.mt < 5)
```
