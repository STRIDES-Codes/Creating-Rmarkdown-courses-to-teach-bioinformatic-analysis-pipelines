...
```{r examine_data, exercise = TRUE, exercise.setup="setupA", exercise.eval = FALSE }
...
```{r check_data1, exercise = TRUE, exercise.setup="setupA", exercise.eval = FALSE}
dense.size <- object.size(as.matrix(pbmc.data))
dense.size
```
...
```{r check_data2, exercise = TRUE, exercise.setup="setupA", exercise.eval = FALSE}
sparse.size <- object.size(pbmc.data)
sparse.size
```
...
```{r check_data3, exercise = TRUE, exercise.setup="setupA", exercise.eval = FALSE}
...
```{r scatter, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r subset, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
pbmc <- subset(pbmc, subset = nFeature_RNA > 200 & nFeature_RNA < 2500 & percent.mt < 5)

```

Exercise - different criteria 
```{r QC_metrics_exercise1, exercise = TRUE, exercise.setup="setupA", exercise.eval = FALSE}
...
```{r normalize, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
pbmc <- NormalizeData(pbmc, normalization.method = "LogNormalize", scale.factor = 10000)
```
...
```{r feature_selection, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r plot_features, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r scale, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
all.genes <- rownames(pbmc)
pbmc <- ScaleData(pbmc, features = all.genes)
```
...
```{r PCA, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
pbmc <- RunPCA(pbmc, features = VariableFeatures(object = pbmc))
```
...
### Check PCA results
```{r PCA_results, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# Examine PCA results 
print(pbmc[["pca"]], dims = 1:5, nfeatures = 5)
```

### Visualize PCA results
```{r PCA_loading, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# Visualize PCA results - the vector loadings in the first 2 dimensions
VizDimLoadings(pbmc, dims = 1:2, reduction = "pca")
```

### Dimention plot
```{r PCA_dim, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
### Heatmap
```{r heatmap, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r PCA_dim_reduction, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r PCA_JS, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r PCA_elbow, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
ElbowPlot(pbmc)
```
...
```{r clustering, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
pbmc <- FindNeighbors(pbmc, dims = 1:10)
pbmc <- FindClusters(pbmc, resolution = 0.5)
```

```{r cluster_id, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r UMAP, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
### Plot with labels
```{r UMAP_label, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r UMAP_plot_save, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r marker_C1, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# find all markers of cluster 1
...
```{r marker_C5, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# find all markers distinguishing cluster 5 from clusters 0 and 3
...
```{r marker_all, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# find markers for every cluster compared to all remaining cells, report only the positive ones
...
```{r marker_p1, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r marker_p2, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
VlnPlot(pbmc, features = c("MS4A1", "CD79A"))
```

### Raw count

```{r marker_p3, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
# you can plot raw counts as well
VlnPlot(pbmc, features = c("NKG7", "PF4"), slot = "counts", log = TRUE)
```


```{r marker_p4, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r marker_p5, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
...
```{r assign, exercise = TRUE, exercise.setup="setupA",  exercise.eval = FALSE}
